...
local font = reaper.ImGui_CreateFont("Segoe UI", fontSize)
font_SidebarSampleTitle = reaper.ImGui_CreateFont("Segoe UI", fontSidebarButtonsSize + 4)
font_SidebarButtons = reaper.ImGui_CreateFont("Segoe UI", fontSidebarButtonsSize)
